            ...
            <div className="space-y-4 font-mono text-xs">
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  <span className="text-slate-400">PagerDuty / Slack Alert Webhook URL</span>
                </div>
                <div className="flex space-x-2">
                  <input
                    type="text"
                    defaultValue="https://events.pagerduty.com/v2/enqueue/intrushield-soc"
                    className="w-full px-3 py-2 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-slate-900 dark:text-slate-300 font-mono"
                  />
                  <Button variant="outline" size="sm" onClick={() => alert('Sample critical alert webhook payload dispatched successfully.')}>
                    Test Alert
                  </Button>
                </div>
              </div>
